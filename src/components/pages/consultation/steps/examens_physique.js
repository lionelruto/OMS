...
const Example = (props) => {
  ...
  return (
    <div>
        ...
        <Card>
            <CardHeader style={{textAlign:'center'}}>Examens Physiques</CardHeader>
          <CardBody>
          <p
        color="primary"
        onClick={toggle}
          ...
          <Collapse isOpen={isOpen}>
            <Row>
              <Col md="6">
                {' '}
                <div style={divStyle}>
                  <FormText>insufisance Cardiaque:</FormText>{' '}
