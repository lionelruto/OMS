           ...
           <Row className="row-eq-height">
            <Col sm="12" md="6" xl="6" style={{cursor:'pointer'}} onClick={this.handleAnalyseClick}>
              ...
              >
                ...
                <FaWeight style={{fontSize:106,color:"#fff"  }} />
            ...
            <Col sm="12" md="6" xl="6" style={{cursor:'pointer'}} onClick={this.handleEnqueteClick}>
              <Statistics
                ...
                iconSide="right"
              >
                <FaTemperatureLow size={106} strokeWidth="1.3" color="#fff" />
              </Statistics>
            </Col>
            <Col sm="12" md="6" xl="6" style={{cursor:'pointer'}} onClick={this.handleHypothseClick}>
              <Statistics
                ...
                iconSide="left"
              >
                <FaHeartbeat size={106} strokeWidth="1.3" color="#fff" />
              </Statistics>
            </Col>
            ...
            <Col sm="12" md="6" xl="6" style={{cursor:'pointer'}} name ='Physique' onClick={this.handlePhysiqExamsClick}>
              <Statistics
                ...
                iconSide="left"
              >
                <FaHeart style={{fontSize:106,color:"#fff"  }} />
              </Statistics>
            </Col>
            ...
            <Col sm="12" md="6" xl="6" style={{cursor:'pointer'}} name ='Physique' onClick={this.handlePhysiqExamsClick}>
              <Statistics
                ...
                iconSide="left"
              >
                <FaMale style={{fontSize:106,color:"#fff"  }} />
              </Statistics>
            </Col>
        </Row>
