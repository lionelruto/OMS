...
import My_Professionnals from '../../components/pages/My_Professionnals'
...
export class Mes_Professionnels extends Component {
    constructor(props) {
        super(props)
...
export default connect(mapStateToProps)(Mes_Professionnels)
