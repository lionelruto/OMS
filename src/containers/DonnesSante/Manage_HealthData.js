...
import HealthData from '../../components/pages/HealthData'
...
export class ManageHealthData extends Component {
    constructor(props) {
        super(props)
...
export default connect(mapStateToProps)(ManageHealthData)
